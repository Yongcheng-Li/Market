...
public class Meeting implements Serializable {
    ...
    public Meeting(int tradeId){
        ...
        this.deliverStatus = "In Progress";
        numberOfEdits = new HashMap<>();
        isAgreed = new HashMap<>();
        isConfirmed = new HashMap<>();
    ...
    /**Getter for the deliver status
     * @return the status for the trade
     */
    public String getDeliverStatus(){return this.deliverStatus;}
    ...
    /**Setter for the deliver status
     * @param deliverStatus the status of the trade
     */
