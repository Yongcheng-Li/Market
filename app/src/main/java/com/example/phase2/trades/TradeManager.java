...
public class TradeManager extends Manager implements Serializable {
    ...
    /**
     * Returns the trade information with the given id
     * @param id The trade id
     * @return The trade's information
     */
    public String getTradeInfo(int id){
        return Objects.requireNonNull(tradeInventory.get(id)).toString();
    }
