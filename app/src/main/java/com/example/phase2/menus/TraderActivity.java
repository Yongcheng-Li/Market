...
public class TraderActivity extends BundleActivity {
    ...
    /**
     * This method is called when the user clicks on the Deliver Trades button. It starts
     * the DeliverItemActivity
     * @param view A view
     */
    public void deliverItems(View view){
        Intent intent = new Intent(this, DeliverItemActivity.class);
        putBundle(intent);
        startActivityForResult(intent, RESULT_FIRST_USER);
    }
